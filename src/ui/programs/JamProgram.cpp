...
JamProgram::JamProgram(QWidget *parent)
    : QWidget(parent), m_preset(new QComboBox(this)),
      ...
      m_sampleRate(new QDoubleSpinBox(this)), m_gain(new QDoubleSpinBox(this)),
      m_type(new QComboBox(this)), m_offset(new QDoubleSpinBox(this)),
      m_bandwidth(new QDoubleSpinBox(this)), m_filePath(new QLineEdit(this)),
